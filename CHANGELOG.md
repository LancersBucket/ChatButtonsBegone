...
- Remove Edit Profile (Profile Popout) not removing when opening profile from the member list
...
- Remove Nitro Advertising not removing profile shop/gift button
- Remove APP/BOT Tags
...
- Option to remove "Show All" VC Button [Servers and Channels]
- Option to remove Unread Mentions and/or Messages Bars [Servers and Channels]
